		...
		<header className='w-full px-32 py-8 font-medium flex items-center justify-between relative z-10 lg:px-16 md:px-12 sm:px-8'>
			...
			{isOpen ? (
				<motion.div
					...
					className='min-w-[70vw] flex-col justify-between z-30 items-center fixed top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 bg-dark/90 dark:bg-light/75 rounded-lg backdrop-blur-md py-32 hidden lg:flex'
				>
					...
					<nav className='flex items-center justify-center flex-wrap mt-2'>
						...
						<motion.a
							...
							whileHover={{ y: -2 }}
							whileTap={{ scale: 0.9 }}
							className='w-6 mx-3 bg-primary rounded-md'
						>
							<InstagramIcon />
						</motion.a>
