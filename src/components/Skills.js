...
const Skills = () => {
	return (
		<>
			...
			lg:bg-circularLightLg lg:dark:bg-circukarDarkLg
			md:bg-circularLightMd md:dark:bg-circukarDarkMd
			sm:bg-circularLightSm sm:dark:bg-circukarDarkSm
			'
			>
				<motion.div
					className='flex items-center justify-center rounded-full font-semibold bg-dark text-light p-8 shadow-dark cursor-pointer dark:text-dark dark:bg-light lg:p-6 md:p-4 md:text-xs xs:text-xs xs:p-2'
					whileHover={{ scale: 1.05 }}
				>
					Software Engeering
				</motion.div>
