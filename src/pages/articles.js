...
const articles = () => {
	return (
		<>
			<Head>
				<title>Chimezie Nwagbo | Articles Page</title>
				<meta
					name='description'
					content='Chimezie Nwagbo software developer articles page'
				/>
			</Head>
...
Follow this step-by-step guide to integrate Pagination component in your React'
							time='9 min read'
							link='/'
							img={article1}
						/>
					...
					<h2 className='font-bold text-4xl w-full text-center my-16 mt-32 dark:text-white'>
						All Articles
					</h2>
					<ul>
						<Article
